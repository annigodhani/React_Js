                      ...
                      <tbody className="divide-y divide-gray-200 bg-white" key={value.id}>
                        <tr>
                              ...
                              <div className="h-10 w-10 flex-shrink-0">
                                {
                                  value.image !== null ?
                                    <img
                                      ...
                                      alt=""
                                    /> :
                                    <p className=' rounded-full bg-black px-3 py-2 text-sm font-bold text-center text-white'>{value.firstname.charAt(0)}</p>
                                }
                              </div>
                              <div className="ml-4">
                          ...
                          <td className="whitespace-nowrap px-4 py-4 text-right text-sm font-medium">
                            ...
                            *:bg-gray-300 px-[20px] py-[8px] me-[10px]  rounded-lg hover:bg-black hover:text-white">
                              Delete
                            </button>
                          </td>
                        </tr>
              ...
              <div className="flex items-center justify-center pt-6">
                ...
                </Link>
                {
                  Array.from({ length: totalpages }, (_, i) => (
                    <NavLink className={'mx-1 flex justify-center items-center rounded-mdborder-gray-400 px-3 py-2 text-gray-300 hover:bg-black hover:text-white'}
